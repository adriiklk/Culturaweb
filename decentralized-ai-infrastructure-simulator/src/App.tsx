                  ...
                  <div>
                    ...
                    <div className="space-y-2 border-t border-white/5 pt-3 text-xs font-mono text-white/60">
                      ...
                      <div className="flex justify-between">
                        <span>Aceleradores de IA:</span>
                        <span className="text-white font-bold">{report.gpusNeeded}x {report.gpuModel}</span>
                      </div>
                      <div className="flex justify-between">
...
function responseHeuristicGenerator(prompt: string): InfrastructureReport {
  ...
  let intensity = "Tareas de consulta estándar";
  ...
  if (norm.includes("video") || norm.includes("image") || norm.includes("film") || norm.includes("creative") || norm.includes("creativo") || norm.includes("diseño") || norm.includes("diseño")) {
    orgType = "Laboratorio Gráfico y Producción de Video";
    scale = "Equipos de Alta Densidad de Rendimiento";
    intensity = "Flujos continuos de coma flotante ultradensos";
