...
function getHeuristicAnalysis(prompt: string) {
  ...
  let intensity = "Carga de Trabajo Moderada";
  ...
  if (norm.includes("video") || norm.includes("image") || norm.includes("generation") || norm.includes("film") || norm.includes("production") || norm.includes("película") || norm.includes("creativo")) {
    ...
    intensity = "Cargas ultra-intensivas de entrenamiento y renderizado";
    ...
    intensity = "Inferencia intermitente de bajo ciclo de trabajo";
    ...
    intensity = "Procesamiento de texto estructurado de nivel medio";
    ...
    intensity = "Inferencia de alta velocidad en tiempo real y baja latencia";
    ...
    intensity = "Cargas de trabajo universitarias de alta concurrencia";
      ...
      config: {
        ...
        responseSchema: {
          ...
          properties: {
            ...
            workloadIntensity: { type: Type.STRING, description: "Visual workload intensity description" },
